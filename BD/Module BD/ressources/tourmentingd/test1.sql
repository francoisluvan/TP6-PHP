...
/*---------------------------------------------------------------------------------
	TODO => Exécution du fichier etapeB.sql (\i etapeB.sql)
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'chefdebord' violates foreign key constraint 'chefdebord_numadh_fkey'
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'chefdebord' violates foreign key constraint 'chefdebord_numact_fkey'
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'chefdebord' violates foreign key constraint 'chefdebord_numbat_fkey'
...
/*------------------------------------------------------------------------
	TODO => Exécution du fichier etapeC.sql (\i etapeC.sql)
		qui régénère le schéma et ajoute quelques données de test
----------------------------------------------------------------------------------*/
...
/* Résultat attendu :
	...
	DETAIL:  Key (numbat, numact)=(1, 1) already exists.
*/
...
/*---------------------------------------------------------------------------------
	TODO => Exécution du fichier etapeD.sql (\i etapeD.sql)
		qui régénère le schéma et ajoute quelques données de test
----------------------------------------------------------------------------------*/
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'equipage' violates foreign key constraint 'equipage_numadh_fkey'
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'equipage' violates foreign key constraint 'equipage_numbat_fkey'
	DETAIL:  Key (numbat, numact)=(2, 1) is not present in table 'chefdebord'.
*/
...
/* Résultat attendu :
	ERROR:  duplicate key value violates unique constraint 'equipage_pkey'
...
/*------------------------------------------------------------------------
	TODO => Exécution du fichier etapeE.sql (\i etapeE.sql)
		qui régénère le schéma et ajoute quelques données de test
		
	Puis au fur et à mesure des tests : dès que vous avez une erreur sur
	un test, corrigez votre schéma et réexecutez le fichier etapeE.sql
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'proprietaire' violates foreign key constraint 'proprietaire_numbat_fkey'
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'loueur' violates foreign key constraint 'loueur_numbat_fkey'
	DETAIL:  Key (numbat)=(3) is not present in table 'bateau'.
*/
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'cotisation' violates foreign key constraint 'cotisation_numadh_fkey'
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'regate' violates foreign key constraint 'regate_numact_fkey'
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'resultat' violates foreign key constraint 'resultat_numact_fkey'
	DETAIL:  Key (numact, numregate)=(2, 2) is not present in table 'regate'.
*/
...
/* Résultat attendu :
	ERROR:  INSERT or update on table 'resultat' violates foreign key constraint 'resultat_numact_fkey1'
...
----------------------------------------------------------------------------------*/
INSERT INTO activite VALUES (30,'sortie','Nantes','Nantes','1/08/2013','1/08/2012');
/* Résultat attendu :
	ERROR:  new row for relation 'activite' violates check constraint...'
*/
